...
export default {
  ...
  setup(props, { emit }) {
     ...
     * - Author: Lê Minh Quang (29/06/2023)
     * @param {{search:string}} keyword - Keyword tìm kiếm
     */
    const updateSearch = (keyword) => {
      emit("updateSearch", keyword.search);
    };
    ...
    const updateDisplaySetting = (headerList) => {
      emit("updateDisplaySetting", headerList);
